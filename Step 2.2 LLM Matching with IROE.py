...
matrix_df = pd.read_excel('Data/LLM Matching.xlsx', index_col=0)
...
sorted_title_sums_df = sorted_title_sums_df.drop(columns=["Summed Multiplied Value"])

# Save the sorted DataFrame to an Excel file
output_path = 'Data/IROE LLM.xlsx'
